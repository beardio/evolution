...
;;    (let ((pos-mate (cons (animal-x animal) (animal-y animal))))) 
    ;;(unless (eq animal-genes animald animal-genes animal)
          (if (and (equal (cons (animal-x animald) (animal-y animald)) (cons (animal-x animal) (animal-y animal)))
                   (>= (animal-energy animald) *reproduction-energy*)
                   (>= (animal-energy animal) *reproduction-energy*))
              ;;(when (>= e *reproduction-energy*)
              (setf (animal-energy animald) (ash (animal-energy animald) -1))
              (setf (animal-energy animal) (ash (animal-energy animald) -1))
              (let ((animal-nu (copy-structure animald))
